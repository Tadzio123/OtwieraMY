...
const Modal = ({
  isOpenState, children, theme, widthSize, heightSize, closeModalState,
}) => isOpenState && (
  <>
    <Overlay />
    <Center>
      <StyledModal heightSize={heightSize} widthSize={widthSize}>
        <IconContainer>
          <Icon name="cancel" color={theme.colorGray40} width="1.6rem" height="1.6rem" onClick={() => closeModalState(false)} cursorType="pointer" />
        </IconContainer>
...
Modal.propTypes = {
  ...
  closeModalState: PropTypes.oneOfType([
    PropTypes.object,
    PropTypes.func,
  ]).isRequired,
